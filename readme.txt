...
- Setelah diekstrak, masuk atau klik folder project-management_arkamaya-main, lalu klik kanan mouse pada layar putih lalu pilih git bash here, jika tidak ada, anda dapat menggunakan cmd lalu copy url path folder nya di atas.
- Setelah terbuka terminal nya maka tuliskan perintah 'composer install'
- Ubah nama file .env.example menjadi .env
- Buka file .env pada bagian DB_DATABASE, ubah nilainya menjadi db_project_azfa
- Buat database dengan nama db_project_azfa dengan cara ketik localhost/phpmyadmin pada browser jangan lupa untuk menyalakan xampp nya dan klik tombol start pada mysql dan apache nya
